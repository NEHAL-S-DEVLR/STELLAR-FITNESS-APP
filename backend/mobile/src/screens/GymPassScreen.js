        ...
        <View style={styles.bodyRow}>
          {pass.photoUrl ? (
            ...
            <View style={[styles.photo, styles.photoPlaceholder]}>
              <Ionicons name="person" size={30} color={colors.outline} />
            </View>
          )}
          <View style={{ flex: 1 }}>
...
const styles = StyleSheet.create({
  ...
  head: { flexDirection: 'row', alignItems: 'center', gap: 12, padding: 20 },
  ...
  bodyRow: { flexDirection: 'row', gap: 16, padding: 20, alignItems: 'center' },
  ...
  qrWrap: { alignItems: 'center', paddingBottom: 24 },
  qr: { width: 130, height: 130, borderRadius: 10, backgroundColor: '#fff' },
